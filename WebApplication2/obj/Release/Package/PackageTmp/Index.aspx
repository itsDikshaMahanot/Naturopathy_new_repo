<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/BaseMaster.master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="WebApplication2.pages.Aboutus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container col-md-12 col-sm-12" style="background-color: floralwhite; padding: 0.2%;">
        <div class="videocontent" style="width: 100%; padding-left: 5%; padding-right: 5%; height: 100%">
            <div class="col-md-12 col-sm-12" style="margin: 5% 0.5%; text-align: center; text-decoration: solid;">
                <p id="welcomeNaturopathy" style="font-size: 250%; font-family: 'Bookman Old Style';" class="test2">
                    Welcome to
                            Naturopathy Center               
                </p>
            </div>
            ...
            <div class="row" style="">
                <div class=" card pcontainer col-md-7" style="box-shadow: -5px -5px darkgray; border-radius: 35px">
                    ...
                    <p class="" style="text-align: justify; font-size: 130%; font-family: Century; padding-top: 2%; padding-left: 2%; padding-bottom: 5%">
                        ...
                        <br />
                        Dr. Sonal Chopra is a self-made well experienced naturopath, acupressurist and dietitian. She has an overall experience of 8 years.
    ...
    <div class="col-md-12 col-sm-11" style="">
    ...
    <div class="container col-sm-12 col-md-12" style="margin-bottom: 2%; margin-top: 2%; margin-left:35%; width:40%;">
        <a class="btn btn-light fa fa-arrow-up" href="#welcomeNaturopathy" style="font-size: x-large;margin-right:1%;margin-left:1%; tooltip: Go Up to the form; z-index: 0; position: relative;" aria-dropeffect="move" aria-expanded="undefined"> TOP </a>
    </div>
